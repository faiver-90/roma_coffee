...
- кабинетом бариста со сканированием QR-кода
...
- автоматическое обновление счетчика кофе после сканирования бариста

### Кабинет бариста
- отдельная страница для бариста
...
После сканирования бариста пользовательский кабинет обновляется автоматически:
...
- повторное начисление кофе при refresh у бариста
